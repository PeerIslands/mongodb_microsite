"""
Azure Function: Blob trigger to transcode event video to HLS and notify backend.

Trigger: New blob in microsite/events/{eventId}/video_url.{ext}
- Downloads blob, runs FFmpeg to produce HLS (master.m3u8 + segments),
- Uploads to microsite/events/{eventId}/video_hls/
- Calls PATCH {BACKEND_BASE_URL}/api/v1/events/{eventId}/hls-ready
